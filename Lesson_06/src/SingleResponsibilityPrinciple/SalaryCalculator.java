...
/**
 * Класс SalaryCalculator представляет собой калькулятор для расчета чистой
 * зарплаты.
 */
public class SalaryCalculator {

    /**
     * Рассчитывает чистую зарплату на основе базовой зарплаты с использованием
     * заданной формулы налогообложения.
     *
